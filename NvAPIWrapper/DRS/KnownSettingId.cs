...
{
    public enum KnownSettingId : UInt32
    {
        /// <summary>
        ...
        /// </summary>
        [Description("Buffer-flipping mode")]
        OpenGLForceBlit = 0x201F619F,
        ...
        /// </summary>
        [Description("Preferred OpenGL GPU")]
        OpenGLImplicitGPUAffinity = 0x20D0F3E6,
        ...
        OpenGLOverlaySupport = 0x206C28C4,
        ...
        /// </summary>
        [Description("Threaded optimization")]
        OpenGLThreadControl = 0x20C1221E,
        ...
        AntiAliasingModeSelector = 0x107EFC5B,

        /// <summary>
        ///    Antialiasing - SLI AA
        /// </summary>
        [Description("Antialiasing - SLI AA")]
        AntiAliasingModeSelectorSLIAntiAliasing = 0x107AFC5B,
        ...
        ///    Enable Ansel
        /// </summary>
        [Description("Enable Ansel")]
        AnselEnable = 0x1075D972,
        ...
        ApplicationSteamId = 0x107CDDBC,

        /// <summary>
        ///    Battery Boost
        /// </summary>
        [Description("Battery Boost")]
        BatteryBoost = 0x10115C89,
        ...
        ///    Maximum GPU Power
        /// </summary>
        [Description("Maximum GPU Power")]
        D3DOpenGLGPUMaximumPower = 0x10D1EF29,
        ...
        FXAAEnable = 0x1074C972,

        /// <summary>
        ///    Enable FXAA Indicator
        /// </summary>
        [Description("Enable FXAA Indicator")]
        FXAAIndicatorEnable = 0x1068FB9C,

        /// <summary>
        ///    SLI indicator
        /// </summary>
        [Description("SLI indicator")]
        MCSFRShowSplit = 0x10287051,
        ...
        PreferredPerformanceState = 0x1057EB71,
        ...
        ///    Frame Rate Limiter
        /// </summary>
        [Description("Frame Rate Limiter")]
        PerformanceStateFrameRateLimiter = 0x10834FEE,
        ...
        ///    Frame Rate Monitor
        /// </summary>
        [Description("Frame Rate Monitor")]
        PerformanceStateFrameRateLimiterGpsControl = 0x10834F01,
        ...
        ///    SLI rendering mode
        /// </summary>
        [Description("SLI rendering mode")]
        SLIRenderingMode = 0x1033CED1,
        ...
        ///    VRR requested state
        /// </summary>
        [Description("VRR requested state")]
        ...
        /// </summary>
        [Description("G-SYNC")]
        VRRApplicationOverride = 0x10A879CF,

        /// <summary>
        ///    G-SYNC
        /// </summary>
        [Description("G-SYNC")]
        VRRApplicationOverrideRequestState = 0x10A879AC,
        ...
        ///    Stereo - Swap eyes
        /// </summary>
        [Description("Stereo - Swap eyes")]
        WKSAPIStereoEyesExchange = 0x11AE435C,

        /// <summary>
        ///    Stereo - Display mode
        /// </summary>
        [Description("Stereo - Display mode")]
        WKSAPIStereoMode = 0x11E91A61,
        ...
        WKSStereoSupport = 0x11AA9E99,

        /// <summary>
        ///    Stereo � swap mode
        /// </summary>
        [Description("Stereo � swap mode")]
        WKSStereoSwapMode = 0x11333333,

        /// <summary>
        ///    Ambient Occlusion
        /// </summary>
        [Description("Ambient Occlusion")]
        AmbientOcclusionMode = 0x667329,
        ...
        ///    ICafe Settings
        /// </summary>
        [Description("ICafe Settings")]
        ICafeLogoConfig = 0xDB1337,
        ...
        PerformanceStateShaderDiskCache = 0x198FFF,
        ...
        ///    PowerThrottle
        /// </summary>
        [Description("PowerThrottle")]
        SetPowerThrottleForPCIeCompliance = 0xAE785C,

        /// <summary>
        ///    VAB Default Data
        /// </summary>
        [Description("VAB Default Data")]
        SetVABData = 0xAB8687,
