...
namespace NvAPIWrapper.Native.Delegates
{
    internal static class GPU
    {
        ...
        public delegate Status NvAPI_EnumLogicalGPUs(
            [In] [Out] [MarshalAs(UnmanagedType.LPArray, SizeConst = LogicalGPUHandle.MaxLogicalGPUs)] LogicalGPUHandle[]
        ...
        public delegate Status NvAPI_EnumPhysicalGPUs(
            [In] [Out] [MarshalAs(UnmanagedType.LPArray, SizeConst = PhysicalGPUHandle.MaxPhysicalGPUs)] PhysicalGPUHandle[]
                gpuHandles, [Out] out uint gpuCount);
        ...
        public delegate Status NvAPI_GPU_GetFullName(
            [In] PhysicalGPUHandle physicalGpu, [Out] out ShortString name);
        ...
        public delegate Status NvAPI_GPU_GetPCIIdentifiers(
            [In] PhysicalGPUHandle physicalGpu, [Out] out uint deviceId, [Out] out uint subSystemId,
        ...
        public delegate Status NvAPI_GPU_GetQuadroStatus(
            [In] PhysicalGPUHandle physicalGpu, [Out] out uint isQuadro);
        ...
        public delegate Status NvAPI_GPU_GetVbiosOEMRevision(
            [In] PhysicalGPUHandle physicalGpu, [Out] out uint biosOEMRevision);

        [FunctionId(FunctionId.NvAPI_GPU_GetVbiosRevision)]
        public delegate Status NvAPI_GPU_GetVbiosRevision(
            [In] PhysicalGPUHandle physicalGpu, [Out] out uint biosRevision);
        ...
        public delegate Status NvAPI_GPU_ValidateOutputCombination(
            [In] PhysicalGPUHandle physicalGpu, [In] OutputId outputMask);
        ...
        public delegate Status NvAPI_SYS_GetDisplayIdFromGpuAndOutputId(
            [In] PhysicalGPUHandle gpu, [In] OutputId outputId, [Out] out uint displayId);
        ...
        public delegate Status NvAPI_SYS_GetGpuAndOutputIdFromDisplayId(
            [In] uint displayId, [Out] out PhysicalGPUHandle gpu, [Out] out OutputId outputId);
