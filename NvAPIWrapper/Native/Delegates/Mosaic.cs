...
namespace NvAPIWrapper.Native.Delegates
{
    internal static class Mosaic
    {
        ...
        public delegate Status NvAPI_Mosaic_EnumDisplayGrids(
            [Accepts(typeof(GridTopologyV2), typeof(GridTopologyV1))] [In] [Out] ValueTypeArray gridTopology,
        ...
        public delegate Status NvAPI_Mosaic_EnumDisplayModes(
            [Accepts(typeof(GridTopologyV2), typeof(GridTopologyV1))] [In] ValueTypeReference gridTopology,
            [Accepts(typeof(DisplaySettingsV2), typeof(DisplaySettingsV1))] [In] [Out] ValueTypeArray
                displaysSettings,
        ...
        public delegate Status NvAPI_Mosaic_GetCurrentTopo(
            ...
            [Accepts(typeof(DisplaySettingsV2), typeof(DisplaySettingsV1))] [In] [Out] ValueTypeReference displaySetting,
        ...
        public delegate Status NvAPI_Mosaic_GetOverlapLimits(
            ...
            [Accepts(typeof(DisplaySettingsV2), typeof(DisplaySettingsV1))] [In] ValueTypeReference displaySetting,
            [Out] out int minOverlapX,
            [Out] out int maxOverlapX, [Out] out int minOverlapY, [Out] out int maxOverlapY);

        [FunctionId(FunctionId.NvAPI_Mosaic_GetSupportedTopoInfo)]
        public delegate Status NvAPI_Mosaic_GetSupportedTopoInfo(
            [Accepts(typeof(SupportedTopologiesInfoV2), typeof(SupportedTopologiesInfoV1))] [In] [Out] ValueTypeReference
                supportedTopoInfo, TopologyType topologyType);

        [FunctionId(FunctionId.NvAPI_Mosaic_GetTopoGroup)]
        public delegate Status NvAPI_Mosaic_GetTopoGroup(
            [In] TopologyBrief topoBrief, [In] [Out] ref TopologyGroup topoGroup);
        ...
        public delegate Status NvAPI_Mosaic_SetDisplayGrids(
            [Accepts(typeof(GridTopologyV2), typeof(GridTopologyV1))] [In] ValueTypeArray gridTopologies,
            [In] uint gridCount, [In] SetDisplayTopologyFlag setTopoFlags);
        ...
        public delegate Status NvAPI_Mosaic_ValidateDisplayGrids(
            ...
            [Accepts(typeof(GridTopologyV2), typeof(GridTopologyV1))] [In] ValueTypeArray gridTopologies,
            [In] [Out] ref DisplayTopologyStatus[] topoStatuses, [In] uint gridCount);
    }
}