...
namespace NvAPIWrapper.Native.Display.Structures
{
    ...
    public struct TimingExtra : IInitializable, IEquatable<TimingExtra>
    {
        ...
        {
            return (_HardwareFlags == other._HardwareFlags) && (_RefreshRate == other._RefreshRate) &&
                   (_FrequencyInMillihertz == other._FrequencyInMillihertz) &&
                   (_VerticalAspect == other._VerticalAspect) && (_HorizontalAspect == other._HorizontalAspect) &&
                   (_PixelRepetition == other._PixelRepetition) && (_Status == other._Status);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is TimingExtra && Equals((TimingExtra) obj);
        }
