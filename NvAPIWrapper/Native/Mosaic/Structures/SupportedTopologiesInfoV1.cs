...
{
    /// <summary>
    ///     Holds informations about supported topologies
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 8)]
    [StructureVersion(1)]
    public struct SupportedTopologiesInfoV1 : ISupportedTopologiesInfo, IInitializable,
        IEquatable<SupportedTopologiesInfoV1>
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MaxSettings)] internal DisplaySettingsV1[]
            _DisplaySettings;
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is SupportedTopologiesInfoV1 && Equals((SupportedTopologiesInfoV1) obj);
        }
